...
if(isset($_POST['nama']) && isset($_POST['alamat']) && isset($_POST['no_hp']) && isset($_POST['tujuan']) && isset($_POST['tanggal']) && isset($_FILES['gambar'])) {
    $nama = $_POST['nama'];
    $alamat = $_POST['alamat'];
    $no_hp = $_POST['no_hp'];
    $tujuan = $_POST['tujuan'];
    ...
    $gambar_baru = $tanggal_sekarang . $nama . "." . $extensi;
    $tmp = $_FILES['gambar']['tmp_name'];

    if(move_uploaded_file($tmp, "img_upload/" . $gambar_baru)) {
        $result = mysqli_query($conn, "INSERT into travel values('','$nama','$alamat','$no_hp','$tujuan','$tanggal', '$gambar_baru')");
