...
if(isset($_POST['id']) && ($_POST['nama']) && isset($_POST['alamat']) && isset($_POST['no_hp']) && isset($_POST['tujuan']) && isset($_POST['tanggal'])) {
    $id = $_POST["id"];
    $nama = $_POST['nama'];
    $alamat = $_POST['alamat'];
    $no_hp = $_POST['no_hp'];
    ...
    $result = mysqli_query($conn, "UPDATE travel set nama='$nama', alamat='$alamat',no_hp='$no_hp',tujuan='$tujuan',tanggal='$tanggal' WHERE id='$id'");
