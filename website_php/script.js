function enableDarkMode() {
  ...
  function showPopup() {
    alert('Jika ada kendala dalam pemesanan tiket harap hubungi nomor wa/telepon yang ada didalam "Tentang Owner/Contact Person agar dibantu dalam pendaftaran');
  }
